...
export const ReportSystemsTable = ({
  columns,
  showAllSystems,
  reportId,
  showActions,
      ...
      <StateViewPart stateKey="noError">
        ...
        <InventoryTable
          ...
          {...(!showAllSystems && {
            ...
            ...(remediationsEnabled && {
              dedicatedAction: (
                <RemediationButton reportId={reportId} systems={selectedIds} />
              ),
            }),
          })}
...
ReportSystemsTable.defaultProps = {
  policyId: '',
  showActions: true,
  enableExport: true,
...
export default ReportSystemsTable;
